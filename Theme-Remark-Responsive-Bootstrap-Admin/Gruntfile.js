...
module.exports = function(grunt) {
  ...
  // Clean task.
  grunt.registerTask('clean-dist', ['clean:css', 'clean:fonts', 'clean:vendor', 'clean:skins', 'clean:examples']);
  ...
  grunt.registerTask('dist-examples', ['concat:examples', 'less:examples', 'autoprefixer:examples', 'csscomb:examples', 'cssmin:examples']);
