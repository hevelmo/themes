<?php include 'inc/config.php'; $template['header_link'] = 'UI LAYOUTS'; $template['sidebar'] = 'sidebar-visible-lg-full sidebar-alt-visible-lg'; ?>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="header-section">
                    <h1>Visible Alternative Sidebar</h1>
                </div>
            </div>
