...
<div id="page-content" class="inner-sidebar-right">
    ...
    <div class="widget chatui chatui-window chatui-window-close">
        <div class="widget-content widget-content-mini themed-background">
            ...
            <i class="fa fa-comment text-light"></i> <a href="javascript:void(0)" class="text-light"><strong>Anna Wigren</strong></a> (2)
        </div>
        ...
        <div class="widget-content widget-content-full chatui-form">
