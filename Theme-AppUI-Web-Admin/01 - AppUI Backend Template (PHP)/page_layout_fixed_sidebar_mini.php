<?php include 'inc/config.php'; $template['header_link'] = 'UI LAYOUTS'; $template['header'] = 'navbar-fixed-top'; $template['sidebar'] = 'sidebar-visible-lg-mini'; ?>
            ...
            <div class="col-sm-6 hidden-xs">
                <div class="header-section">
                    <ul class="breadcrumb breadcrumb-top">
                        <li>UI Layouts</li>
                        <li><a href="">Mini Sidebar (Fixed)</a></li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <!-- END Mini Sidebar (Fixed) Header -->
