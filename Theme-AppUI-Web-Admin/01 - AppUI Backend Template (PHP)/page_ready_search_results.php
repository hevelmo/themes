    ...
    <div class="block">
        ...
        <div class="block-title">
            <ul class="nav nav-tabs" data-toggle="tabs">
                ...
                <li><a href="#search-tab-projects">Projects</a></li>
            </ul>
        </div>
        ...
        <div class="tab-content">
            ...
            <!-- Projects Results -->
            <div class="tab-pane" id="search-tab-projects">
                <table class="table table-striped table-borderless table-vcenter">
                    <thead>
                        <tr>
                            <th class="text-center hidden-xs" style="width: 140px;">AUTHOR</th>
                            <th>PROJECT</th>
                            <th class="text-center hidden-xs" style="width: 20%;">SALES</th>
                            <th class="text-center" style="min-width: 130px; width: 20%;">EARNINGS</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>Admin Template</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-danger">HTML</a>
                                    <a href="javascript:void(0)" class="label label-warning">CSS</a>
                                    <a href="javascript:void(0)" class="label label-success">PHP</a>
                                </p>
                            </td>
                            <td class="text-center hidden-xs">
                                <h2><strong>2800</strong></h2>
                            </td>
                            <td class="text-center">
                                <h2><small>$</small> <strong>42.300</strong></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center hidden-xs">
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>HTML Template</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-danger">HTML</a>
                                    <a href="javascript:void(0)" class="label label-warning">CSS</a>
                                    <a href="javascript:void(0)" class="label label-default">JS</a>
                                </p>
                            </td>
                            <td class="text-center hidden-xs">
                            ...
                            <td class="text-center">
                                <h2><small>$</small> <strong>38.220</strong></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center hidden-xs">
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>Email Template</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-danger">HTML</a>
                                    <a href="javascript:void(0)" class="label label-warning">CSS</a>
                            ...
                            <td class="text-center">
                                <h2><small>$</small> <strong>10.000</strong></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center hidden-xs">
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>Icon Pack</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-info">Photoshop</a>
                                </p>
                            </td>
                            <td class="text-center hidden-xs">
                                <h2><strong>4750</strong></h2>
                            </td>
                            <td class="text-center">
                                <h2><small>$</small> <strong>75.960</strong></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center hidden-xs">
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>Web Application</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-danger">HTML</a>
                                    <a href="javascript:void(0)" class="label label-warning">CSS</a>
                                    <a href="javascript:void(0)" class="label label-success">Ruby</a>
                                </p>
                            </td>
                            <td class="text-center hidden-xs">
                                <h2><strong>6321</strong></h2>
                            </td>
                            <td class="text-center">
                                <h2><small>$</small> <strong>28.720</strong></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center hidden-xs">
                            ...
                            <td>
                                <h3>
                                    <a href="javascript:void(0)"><strong>Wordpress Theme</strong></a>
                                </h3>
                                <p>
                                    <a href="javascript:void(0)" class="label label-danger">HTML</a>
                                    <a href="javascript:void(0)" class="label label-warning">CSS</a>
                            ...
                            <td class="text-center hidden-xs">
                                <h2><strong>612</strong></h2>
                            </td>
                            <td class="text-center">
                                <h2><small>$</small> <strong>51.350</strong></h2>
                            </td>
                        </tr>
                    </tbody>
                </table>
