...
copy: {
  ...
  express:{
      files: [{
          ...
          src: ['**/*'],
          expand: true,
          cwd: '../getting_started/assets/js',
          dest: '../boilerplates/<%= config.appex %>/public/javascripts'
      },{
          src: ['**/*'],
          expand: true,
          cwd: '../getting_started/assets/less/',
  ...
  sails:{
      files: [{
          ...
          src: ['pages.js'],
          expand: true,
          cwd: '../getting_started/pages/js',
          dest: '../boilerplates/<%= config.appSails %>/assets/js/'       
      },{
          src: ['pages-icons.css','editor.css','windows.chrome.fix.css'],
          expand: true,
          cwd: '../getting_started/pages/css',
          dest: '../boilerplates/<%= config.appSails %>/assets/styles/'        
      },{
          src: ['**/*'],
          expand: true,
          cwd: '../getting_started/pages/less',
          dest: '../boilerplates/<%= config.appSails %>/assets/styles/'       
      },{
          src: ['**/*'],
          expand: true,
          cwd: '../getting_started/pages/fonts',
